...
//                writeObject(messager, socket);
    ...
    public static String getIPv4() {
    	...
    	try {
            ...
            //tra ve 1 doi tuong dai dien cho dia chi IP cua may tinh dang chay chuong trinh
            ip = myIP.getHostAddress();
            //lay dia chi IP duoi dang chuoi String
    ...
    public static Socket findSocketByUser(User user) {
    	...
    	//neu object u la key trong list users
